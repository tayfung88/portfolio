    ...
    return (
        <footer className="bg-gray-800 text-white py-6 mt-auto">
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-4 md:mt-0">
                        <ul className="example-2">
                            <li className="icon-content">
                                <a
                                href="https://www.linkedin.com/in/tayfunguglu"
                                target="_blank"
                                aria-label="LinkedIn"
                            ...
                            <li className="icon-content">
                                <a
                                href="https://github.com/tayfung88"
                                target="_blank"
                                aria-label="GitHub"
                                data-social="github"
                                >
                ...
                <div>
                    <a href="#top" className="flex flex-start ">
                ...
                <div className="text-center mt-4">
                    <p className="text-gray-400 text-sm">
                        &copy; {new Date().getFullYear()} Tayfun GUGLU. Tous droits réservés.
                    </p>
                </div>
            </div>
        </footer>
