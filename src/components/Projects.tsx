...
const ProjectsList: React.FC = () => {
    ...
    return (
        <section className="px-4 py-16 max-w-7xl mx-auto">
            <h2 className="text-3xl font-semibold text-gray-900 mb-8">Mes Projets</h2>
            <div className="space-y-8">
                {projects.map((project, index) => (
                    <div key={index} className="border rounded-lg shadow-md p-6 bg-white hover:shadow-lg transition-shadow duration-300">
                        ...
                        >
                            ...
                            <p className="text">Code Source</p>
                            </button>
                        </a>
                    </div>
                ))}
